...
public class CircleImageView extends ImageView {
    ...
    private static final int DEFULT_TYPE = TYPE_CIRCLE;
    private static final int DEFAULT_ROUNDRECT_CORNER = 5;
    ...
    private int roundRect_corner = DEFAULT_ROUNDRECT_CORNER;
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mType = a.getInt(R.styleable.CircleImageView_type, DEFULT_TYPE);
        roundRect_corner = a.getDimensionPixelSize(R.styleable.CircleImageView_round_rect_corner, DEFAULT_ROUNDRECT_CORNER);
